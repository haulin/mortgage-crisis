Stub file for VScode's intellisense when using python. With this stub file, linters should no longer complain.

Comes from issue [#2350](https://github.com/nesbox/TIC-80/issues/2350).
