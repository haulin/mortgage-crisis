...
This function is **not** part of the [API](API). See the [cart](https://tic80.com/play?cart=3600) for a demonstration.
...
## Description
Extended print function that automatically goes to line, align text in various ways and much more. See the demo [cart](https://tic80.com/play?cart=3600).

You need to copy-paste this in your code to use it:
```lua
-- MIT License
-------------------
--EXTENDED PRINT
